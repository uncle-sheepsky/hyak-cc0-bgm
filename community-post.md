...
> 이미지 1장(트랙 목록/커버) + 아래 텍스트 + GitHub 릴리스 링크. 링크는 커뮤니티 탭 본문에 그대로 첨부.

---

## 한국어

🎧 hyak의 ep1~7 BGM 풀버전(2~3분)을 **CC0(퍼블릭 도메인)**로 풀었습니다.
...
🎧 Full versions (2–3 min) of hyak's ep1–7 BGM, released into the public domain under **CC0**.
...
## 게시 체크리스트
- [ ] GitHub 리포 public + 릴리스에 `cc0-bgm-pack` (flac/mp3 zip) 첨부
- [ ] 릴리스 노트에 README 내용 붙여넣기
- [ ] 커뮤니티 탭에 위 문안 + 링크 (KR 채널이면 한국어, 필요 시 영문 병기)
- [ ] (선택) 각 영상 설명란에도 "이 곡 CC0로 공개: (링크)" 1줄 추가
- [ ] (선택) archive.org 미러
